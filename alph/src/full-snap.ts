...
import fs from "fs";
import { Network, PoolKey } from "@invariant-labs/alph-sdk";
...
export const createSnapshotForNetwork = async (network: Network) => {
  ...
  switch (network) {
    case Network.Mainnet:
      fileName = "../data/alph/full_mainnet.json";
      dataFileName = "../data/alph/mainnet.json";
      break;
    default:
      fileName = "../data/alph/full_testnet.json";
      dataFileName = "../data/alph/testnet.json";
      break;
  }
