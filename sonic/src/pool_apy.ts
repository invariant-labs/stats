...
import { poolAPY, WeeklyData } from "@invariant-labs/sdk-sonic/lib/utils";
import { PublicKey } from "@solana/web3.js";
import fs from "fs";
import TESTNET_APY from "../../data/sonic/pool_apy_testnet.json";
import TESTNET_ARCHIVE from "../../data/sonic/pool_apy_archive_testnet.json";
import MAINNET_APY from "../../data/sonic/pool_apy_mainnet.json";
import MAINNET_ARCHIVE from "../../data/sonic/pool_apy_archive_mainnet.json";
import {
  ApySnapshot,
...
export const createSnapshotForNetwork = async (network: Network) => {
  ...
  switch (network) {
    case Network.TEST:
      ...
      fileName = "../data/sonic/pool_apy_testnet.json";
      archiveFileName = "../data/sonic/pool_apy_archive_testnet.json";
      ticksFolder = "../data/sonic/ticks/testnet/";
