...
export const createSnapshotForNetwork = async (network: Network) => {
  ...
  switch (network) {
    case Network.TEST:
      ...
      fileName = "../data/sonic/full_testnet.json";
      dataFileName = "../data/sonic/testnet.json";
      poolsApyFileName = "../data/sonic/daily_pool_apy_testnet.json";
    ...
    case Network.MAIN:
      ...
      poolsApyFileName = "../data/sonic/daily_pool_apy_mainnet.json";
...
createSnapshotForNetwork(Network.TEST).then(
  () => {
    console.log("sonic: Full testnet snapshot done!");
  },
  (err) => {
    console.log(err);
  }
