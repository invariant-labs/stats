...
export const createSnapshotForNetwork = async (network: Network) => {
  ...
  switch (network) {
    case Network.TEST:
      ...
      folderName = "../data/soon/ticks/testnet/";
      break;
    case Network.MAIN:
      provider = AnchorProvider.local("https://rpc.mainnet.soo.network/rpc");
      folderName = "../data/soon/ticks/mainnet/";
      break;
    default:
...
createSnapshotForNetwork(Network.TEST).then(
  () => {
    console.log("Soon: Testnet ticks snapshot done!");
  },
  (err) => {
    console.log(err);
  }
...
//   () => {
//     console.log("Soon: Mainnet ticks snapshot done!");
//   },
//   (err) => {
//     console.log(err);
//   }
