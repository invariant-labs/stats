...
import { poolAPY, WeeklyData } from "@invariant-labs/sdk-soon/lib/utils";
import { PublicKey } from "@solana/web3.js";
import fs from "fs";
import TESTNET_APY from "../../data/soon/pool_apy_testnet.json";
import TESTNET_ARCHIVE from "../../data/soon/pool_apy_archive_testnet.json";
import MAINNET_APY from "../../data/soon/pool_apy_mainnet.json";
import MAINNET_ARCHIVE from "../../data/soon/pool_apy_archive_mainnet.json";
import {
  ApySnapshot,
...
export const createSnapshotForNetwork = async (network: Network) => {
  ...
  switch (network) {
    case Network.TEST:
      ...
      fileName = "../data/soon/pool_apy_testnet.json";
      archiveFileName = "../data/soon/pool_apy_archive_testnet.json";
      ticksFolder = "../data/soon/ticks/testnet/";
      apySnaps = TESTNET_APY as Record<string, ApySnapshot>;
    ...
    case Network.MAIN:
      ...
      fileName = "../data/soon/pool_apy_mainnet.json";
      archiveFileName = "../data/soon/pool_apy_archive_mainnet.json";
      ticksFolder = "../data/soon/ticks/mainnet/";
      apySnaps = MAINNET_APY as Record<string, ApySnapshot>;
