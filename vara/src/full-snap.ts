...
import fs from "fs";
import { Network, PoolKey } from "@invariant-labs/vara-sdk";
...
export const createSnapshotForNetwork = async (network: Network) => {
  ...
  switch (network) {
    case Network.Mainnet:
      fileName = "../data/vara/full_mainnet.json";
      dataFileName = "../data/vara/mainnet.json";
      // poolsApyFileName = "../data/a0/pool_apy_mainnet.json";
      break;
    default:
      fileName = "../data/vara/full_testnet.json";
      dataFileName = "../data/vara/testnet.json";
