...
import fs from 'fs'
import DEVNET_POOL_APY from '../data/pool_apy_devnet.json'
import MAINNET_POOL_APY from '../data/pool_apy_mainnet.json'
import {
  devnetTokensData,
  getTokensData,
  getTokensPrices,
...
export const createSnapshotForNetwork = async (network: Network) => {
  ...
  switch (network) {
    case Network.MAIN:
      ...
      snaps = MAINNET_POOL_APY as Record<string, QuotientSnapshot[]>
    ...
    default:
      ...
      snaps = DEVNET_POOL_APY as Record<string, QuotientSnapshot[]>
