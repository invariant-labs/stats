...
import { poolAPY, WeeklyData } from "@invariant-labs/sdk-fogo/lib/utils";
import { PublicKey } from "@solana/web3.js";
import fs from "fs";
import TESTNET_APY from "../../data/fogo/pool_apy_testnet.json";
import TESTNET_ARCHIVE from "../../data/fogo/pool_apy_archive_testnet.json";
import MAINNET_APY from "../../data/fogo/pool_apy_mainnet.json";
import MAINNET_ARCHIVE from "../../data/fogo/pool_apy_archive_mainnet.json";
import {
  ApySnapshot,
...
export const createSnapshotForNetwork = async (network: Network) => {
  ...
  switch (network) {
    case Network.TEST:
      ...
      fileName = "../data/fogo/pool_apy_testnet.json";
      archiveFileName = "../data/fogo/pool_apy_archive_testnet.json";
      ticksFolder = "../data/fogo/ticks/testnet/";
    ...
    case Network.MAIN:
      ...
      fileName = "../data/fogo/pool_apy_mainnet.json";
      archiveFileName = "../data/fogo/pool_apy_archive_mainnet.json";
      ticksFolder = "../data/fogo/ticks/mainnet/";
...
createSnapshotForNetwork(Network.TEST).then(
  () => {
    console.log("Fogo: Testnet pool apy snapshot done!");
  },
  (err) => {
    console.log(err);
  }
...
//   () => {
//     console.log("Fogo: Mainnet pool apy snapshot done!");
//   },
//   (err) => {
//     console.log(err);
//   }
