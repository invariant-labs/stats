...
import fs from "fs";
import TESTNET_DATA from "../../data/fogo/testnet.json";
import MAINNET_DATA from "../../data/fogo/mainnet.json";
import TESTNET_APY_ARCHIVE from "../../data/fogo/daily_pool_apy_testnet.json";
import MAINNET_APY_ARCHIVE from "../../data/fogo/daily_pool_apy_mainnet.json";
import {
  isSameWeek,
  PoolStatsData,
  readPoolsFromCache,
...
export const createSnapshotForNetwork = async (network: Network) => {
  ...
  switch (network) {
    case Network.TEST:
      ...
      intervalsPath = "../data/fogo/intervals/testnet/";
      fileName = "../data/fogo/testnet_intervals.json";
      break;
    case Network.MAIN:
      ...
      intervalsPath = "../data/fogo/intervals/mainnet/";
      fileName = "../data/fogo/mainnet_intervals.json";
      break;
    default:
  ...
  for (let poolKey of poolKeys) {
    ...
    if (!pool) {
      pool = (await market.getPoolByAddress(
...
createSnapshotForNetwork(Network.TEST).then(
  () => {
    console.log("Fogo: Testnet intervals aggregated!");
  },
  (err) => {
    console.log(err);
  }
...
//   () => {
//     console.log("Fogo: Mainnet intervals aggregated!");
//   },
//   (err) => {
//     console.log(err);
//   }
